...
bullets("처음 켤 때 · 권한을 '나 대신 승인'으로", "자기 PC에서 혼자 쓰면 — 막힘없이 빠르게", [
    ...
    ("<span class='mute'>매번 안 고르려면 한 번만 <b>~/.codex/config.toml</b>에 <b>approval_policy=\"never\"</b> 적어두면 끝.</span>", ""),
])
bullets("AI 직원 부르는 법", "세 가지 — 말로, 콕 집어, 목록에서", [
    ("<b>① 그냥 말로</b> — '~하고 싶어' 하면 AI가 <b>알맞은 코치를 알아서</b> 골라요. (제일 쉬움)", ""),
    ("<b>② 콕 집어</b> — 이름 앞에 <b>$</b>. 예: <b>$ai-agent-maker</b>(마스터), <b>$knowledge-keeper</b>(사업 지식 노트).", "c"),
...
bullets("이런 것도 됩니다 (강의에서 직접 보여드려요)", "복붙 끝나면 — 말만 하면 따라와요", [
    ...
    ("<b>정해진 시각에 자동</b> — 사이드바 <b>'예약됨'</b>에 '매일 아침 9시에 ~' 걸어두기.", "c"),
