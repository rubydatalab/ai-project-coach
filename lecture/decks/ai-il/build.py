...
bullets("처음 한 번 · ① Codex 설치", "이 순서대로 하면 됩니다", [
    ("<b>1.</b> <b>PowerShell</b> 열기 (시작 → 'PowerShell' 검색)", ""),
    ("<b>2.</b> 붙여넣고 Enter — <b>irm https://chatgpt.com/codex/install.ps1 | iex</b>", "c"),
    ("<b>3.</b> PowerShell <b>닫았다 다시 열기</b>", ""),
    ("<b>4.</b> <b>codex</b> 입력 → <b>'Sign in with ChatGPT'</b>로 로그인 (비번은 사장님이)", "c"),
    ("<span class='mute'>Node가 있으면 2번 대신</span> <b>npm install -g @openai/codex</b>", "v"),
])
...
bullets("처음 켤 때 · 권한 모드 고르기", "빠르게(추천) vs 조심스럽게 — 둘 중 하나", [
    ("처음 켜면(또는 <b>/permissions</b>) 모드를 골라요. <b>자기 PC에서 혼자</b> 쓰면:", ""),
    ("<b>✅ Full Access</b> ← 추천 — AI가 <b>막힘 없이 빠르게</b> 일해요. 매번 안 물어봐서 답답함이 없어요.", ""),
    ("<b>⚠️ 대신 안전은 사람이</b> — <b>결제·발송·삭제·게시 버튼은 늘 사장님이 직접.</b> 코치도 위험한 건 멈추고 물어보게 돼 있어요.", "v"),
    ("<span class='mute'>더 조심스럽게는 <b>Auto</b>(폴더 안만, 위험한 건 물어봄) — 단 자주 물어봐 답답할 수 있어요(특히 Windows).</span>", "c"),
    ("<b>매번 안 고르려면</b> — 한 번만 <b>~/.codex/config.toml</b>에 <b>approval_policy=\"never\"</b> · <b>sandbox_mode=\"danger-full-access\"</b> 적어두면 끝.", ""),
])
...
glossary2("자주 쓰는 명령어 · 외우지 말고 곁에 두기", "대화 중에 '/'로 부르는 것들", [
    ...
    ("/permissions", "AI에게 뭘 허용할지 — 자기 PC면 Full Access"),
