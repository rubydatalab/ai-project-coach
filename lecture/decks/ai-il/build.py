...
bullets("처음 한 번 · 권한은 'Auto'로", "AI가 일하려면 권한이 필요해요 — 안전하게", [
    ("처음 켜면(또는 <b>/permissions</b>로) 권한 모드를 고를 수 있어요. 셋 중 하나:", ""),
    ("<b>✅ Auto</b> ← 이거 고르세요 — 작업 폴더 안에선 <b>알아서 읽고 쓰고</b>, 폴더 밖·삭제·결제 같은 <b>위험한 건 멈추고 물어봐요.</b>", ""),
    ("<span class='mute'>Read Only — 보기만 하고 못 고쳐요(너무 답답).</span>", "c"),
    ("<b>⚠️ Full Access — 전부 허용. 안전장치가 꺼져요. 쓰지 마세요.</b>", "v"),
])
glossary2("자주 쓰는 명령어 · 외우지 말고 곁에 두기", "대화 중에 '/'로 부르는 것들", [
    ...
    ("/permissions", "AI에게 뭘 허용할지 — Auto 권장"),
